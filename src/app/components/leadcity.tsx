    ...
    return (
        <div className="bg-[#DAE5EB] px-40 ">
            ...
            <div className="flex justify-center pt-8 pb-6">
                <button className="bg-[#5F96B4] text-white rounded-3xl mr-2 px-6 py-2">Learn more</button>
                <button className="text-[#5F96B4] rounded-3xl px-6 py-2 border border-[#5F96B4]">Virtual Tour</button>
            </div>
        </div>
    )
}